...
describe('FinancialYearCalculator', () => {
	describe('AustralianFinancialYearCalculator', () => {
		it('should return FY2024-25 for 2025-06-30 (end of FY)', () => {
			...
			expect(fy.label).to.equal('FY2024-25');
		});

		it('should return FY2025-26 for 2025-07-01 (start of FY)', () => {
			const calc = new AustralianFinancialYearCalculator();
			...
			expect(fy.label).to.equal('FY2025-26');
		});
	});

	describe('USFinancialYearCalculator', () => {
		it('should return FY2025 for 2025-09-30 (end of FY)', () => {
			...
			expect(fy.label).to.equal('FY2025');
		});

		it('should return FY2026 for 2025-10-01 (start of FY)', () => {
			const calc = new USFinancialYearCalculator();
			...
			expect(fy.label).to.equal('FY2026');
		});
	});

	describe('UKFinancialYearCalculator', () => {
		it('should return 2024-25 for 2025-04-05 (end of FY)', () => {
			...
			expect(fy.label).to.equal('2024-25');
		});

		it('should return 2025-26 for 2025-04-06 (start of FY)', () => {
			const calc = new UKFinancialYearCalculator();
			...
			expect(fy.label).to.equal('2025-26');
		});
	});

	describe('CanadianFinancialYearCalculator', () => {
		it('should return FY2024-25 for 2025-03-31 (end of FY)', () => {
		...
		it('should return FY2025-26 for 2025-04-01 (start of FY)', () => {
			const calc = new CanadianFinancialYearCalculator();
	...
	describe('CalendarYearCalculator', () => {
		it('should return CY2025 for 2025-09-24', () => {
			...
			expect(fy.label).to.equal('CY2025');
		});
	});
    ...
    describe('Leap Year Cases', () => {
 		it('should handle leap year for AustralianFinancialYearCalculator', () => {
            ...
            expect(fy.end.getMonth()).to.equal(5);    // June
            expect(fy.end.getDate()).to.equal(30);         
            expect(fy.label).to.equal('FY2023-24');
        }); 
    });
});
